...
const DamageProductsModal = ({ 
  ...
  useEffect(() => {
    if (order && order.items) {
      ...
      console.log('Initial damaged products:', initialDamagedProducts);
    }
  }, [order]);
  ...
  const calculateTotals = () => {
    ...
    // Debug logging
    console.log('Calculating totals for products:', damagedProducts);
    ...
    console.log('Final calculation:', { totalBill, totalDamagedCost, finalBill });
  ...
  const handleConfirmDelivery = async () => {
    ...
    if (loading) {
      console.log('🚫 Delivery already in progress, ignoring duplicate request');
      return;
    }
  ...
  console.log('Modal is showing with order:', order);
...
export default DamageProductsModal;
